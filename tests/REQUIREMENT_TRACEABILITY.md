...
| FR-003 | External LLM instruction validation accepts safe actions and rejects unsafe/schema-invalid actions | `tests/unit/test_phase10_external_loop.py::test_valid_external_instruction_is_accepted_audited_and_resumes_safely`, `tests/unit/test_phase10_external_loop.py::test_unsafe_external_instruction_is_policy_blocked_and_not_applied` |
| FR-014 | Failure-injection matrix pauses for external instruction without worker repair or reasoning | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair` |
| FR-026 | Instruction audit events cover received, accepted, rejected, and policy-blocked outcomes | `tests/unit/test_phase10_external_loop.py::test_valid_external_instruction_is_accepted_audited_and_resumes_safely`, `tests/unit/test_phase10_external_loop.py::test_unsafe_external_instruction_is_policy_blocked_and_not_applied` |
| FR-029 | Decision-required endpoint and worker context package non-authoritative memory for external LLM/Codex/Kiro use | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair` |
| AC-011 | YAML syntax error fixture pauses with deterministic reason code | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[yaml_syntax_error-YAML_SYNTAX_INVALID]` |
| AC-012 | Dry-run failure fixture pauses with deterministic reason code | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[dry_run_failure-DRY_RUN_FAILED]` |
| AC-013 | Resource already exists fixture pauses with deterministic reason code | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[resource_exists-RESOURCE_ALREADY_EXISTS]` |
| AC-014 | Immutable field conflict fixture pauses with deterministic reason code | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[immutable_conflict-IMMUTABLE_FIELD_CONFLICT]` |
| AC-015 | Helm render failure fixture pauses with deterministic reason code | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[helm_render_failure-HELM_RENDER_FAILED]` |
| AC-016 | PVC pending and pod unschedulable fixtures pause with deterministic reason codes | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[pvc_pending-PVC_PENDING]`, `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[pod_unschedulable-POD_UNSCHEDULABLE]` |
| AC-017 | Node unavailable fixture pauses with deterministic reason code | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[node_unavailable-NODE_UNAVAILABLE]` |
| AC-018 | Validation failure fixture pauses with deterministic reason code and redacted context | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[validation_failure-VALIDATION_FAILED]` |
| AC-019 | Valid external instructions resume safely and unsafe external instructions remain blocked | `tests/unit/test_phase10_external_loop.py::test_valid_external_instruction_is_accepted_audited_and_resumes_safely`, `tests/unit/test_phase10_external_loop.py::test_unsafe_external_instruction_is_policy_blocked_and_not_applied` |
| NFR-011 | Ingress conflict, MCP outage, and timeout fixtures pause through structured MCP error paths | `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[ingress_conflict-INGRESS_CONFLICT]`, `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[mcp_outage-MCP_UNAVAILABLE]`, `tests/unit/test_phase10_external_loop.py::test_failure_fixtures_pause_for_external_llm_without_repair[timeout-TIMEOUT_EXCEEDED]` |
| FR-027 | Memory layers cover in-run, durable job, resource state, episodic execution, semantic failure, policy, approval, audit, and observability context | `tests/unit/test_phase11_memory_audit.py::test_memory_store_supports_phase11_layers_filters_and_authority` |
| FR-029 | Memory retrieval filters namespace, chart, kind, error code, MCP source, tenant, and environment | `tests/unit/test_phase11_memory_audit.py::test_memory_store_supports_phase11_layers_filters_and_authority`, `tests/unit/test_phase11_memory_audit.py::test_memory_context_filters_by_error_code_and_policy_source` |
| AC-027 | Memory responses are context-only and cannot trigger execution or state transitions | `tests/unit/test_phase11_memory_audit.py::test_memory_context_is_context_only_and_cannot_transition_job_state` |
| AC-028 | Memory writes are redacted | `tests/unit/test_phase11_memory_audit.py::test_memory_writes_are_redacted` |
| FR-026 / AC-022 | Representative job audit includes creation, transition, instruction, approval, and report events | `tests/unit/test_phase11_memory_audit.py::test_representative_job_audit_is_complete` |
| NFR-003 / NFR-010 | Memory and audit context remains durable, append-only, and non-authoritative | `tests/unit/test_phase2_persistence.py::test_json_repository_persists_and_rehydrates_execution_records`, `tests/unit/test_phase11_memory_audit.py` |
